...
if incrementalEmpDf.count() == 0:
    ...
    dynamoDf = glueContext.create_dynamic_frame.from_options(
        ...
        connection_options={"dynamodb.input.tableName": "project_data",
    ...
    if existingDyanmoDf.count() != 0:
        ...
        existingDyanmoDfRenamed = existingDyanmoDf.select("name_list").withColumnRenamed("name_list","existing_employee_name")
        
        print("Perform Join condition")
        joinedDf = incrementalEmpDf.join(existingDyanmoDfRenamed, incrementalEmpDf.name_list == existingDyanmoDfRenamed.existing_employee_name, "left")
    ...
    try:
        glueContext.write_dynamic_frame_from_options(
            ...
            connection_type="dynamodb",
            connection_options={"dynamodb.output.tableName": "project_data",
